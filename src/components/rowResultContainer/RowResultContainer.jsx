        ...
        <div className="table">
            ...
            <thead>
                <tr>
                    ...
                    <th>Roll</th>
                    {
                      data.results && data.results[0].subjets.map((elm)=><th colSpan={4}>Subject,Grade and Mark</th>)
            ...
            <tbody>
                {
                    ...
                    data.results &&  data.results.map((elm)=><RowResult data={elm}/>) 
